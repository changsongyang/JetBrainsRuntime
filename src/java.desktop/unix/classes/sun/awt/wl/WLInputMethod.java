...
public final class WLInputMethod extends InputMethodAdapter {
    ...
    private interface ZwpTextInputV3 {
        ...
        final class InputContextState
        {
            ...
            public InputContextState setTextInputEnabled(final boolean enabled) {
    ...
    private void zwp_text_input_v3_onLeave(long leftWlSurfacePtr) {
        ...
        wlInputContextState
            // Values set with this event aren't buffered, so
            //   we shouldn't wait for a {@code zwp_text_input_v3::done} event to apply them.
            .setCurrentWlSurfacePtr(0)
            // A context can't be enabled but not associated with a surface.
